...
TypeX ==
    \/ Terminal!TypeX /\ Turntable!TypeX /\ Beam!TypeX
TypeE ==
    \/ Terminal!TypeE /\ Turntable!TypeE /\ Beam!TypeE
TypeUp ==
...
TypeB ==
    \/ Terminal!TypeB /\ UNCHANGED turntableVars /\ Beam!TypeB
Rotate ==
    \/ UNCHANGED terminalVars /\ Turntable!Rotate /\ UNCHANGED beamVars
fireXray ==
    \/ UNCHANGED terminalVars /\ UNCHANGED turntableVars /\ Beam!fireXray
fireElectron ==
    \/ UNCHANGED terminalVars /\ UNCHANGED turntableVars /\ Beam!fireElectron
